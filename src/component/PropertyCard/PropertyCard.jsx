      ...
      <div className="rounded-xl overflow-hidden  hover:shadow transition-shadow duration-300 cursor-pointer p-2 bg-white border-2 border-[#f7f7f7]">
        ...
        <div className="relative">
          ...
          <div className="absolute top-2 left-2 flex items-center gap-2 text-white px-2 py-1 rounded-md text-sm font-medium">
           <FaMapMarkerAlt /> {property.destination}
          </div>
        ...
        <div className="pt-4 flex justify-between items-start">
          ...
          <div>
            <h3 className=" text-md mb-1 text-[#141414]">{property.title}</h3>
            <p className="text-[#141414] text-sm font-bold mb-2 flex items-center  gap-2">
              {property.capacity.bedrooms} <IoBedOutline className='text-xl' /> | {property.capacity.bathrooms}<LiaBathSolid className='text-xl' />
            </p>
          </div>
